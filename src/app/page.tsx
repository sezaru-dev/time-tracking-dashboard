...
export default function Home() {
  ...
  return (
    <main className="grid grid-cols-1 lg:grid-cols-4 container lg:max-w-[1140px] mx-auto gap-6 lg:gap-8 px-6 py-20">
      <section className="col-span-1 lg:row-span-2 bg-darkBlue rounded-2xl overflow-hidden h-full">
      ...
      <section className="col-span-1 lg:col-span-3 row-span-2 grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
        {data.map((item, index) => (
          <Card key={index}
            {...item}
